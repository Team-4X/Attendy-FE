...
export const NavBar = () => {
  ...
  return (
    <nav class="navbar is-light is fixed-top mt-2 mx-2 level">
      ...
      <span className="is-hidden-tablet level-left ml-5 has-text-danger-dark is-clickable" onClick={showMenus}>Attendy</span>
      <div onClick={showMenus} role="button" className="navbar-burger" aria-label="menu" aria-expanded="false">
